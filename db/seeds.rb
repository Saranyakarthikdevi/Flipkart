...
# encoding: utf-8
Item.delete_all
Item.create!(title: 'Rails, Angular, Postgres, and Bootstrap',
  description:
    %{<p>
  ...
  price: 45.00)
# . . .
Item.create!(title: 'Seven Mobile Apps in Seven Weeks',
  description:
    %{<p>
...
Item.create!(title: 'Ruby Performance Optimization',
  description:
    %{<p>
